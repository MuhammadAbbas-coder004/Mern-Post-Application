  ...
  const handleShare = (platform, post) => {
    ...
    switch(platform) {
      ...
      case 'facebook':
        ...
        break;
      case 'instagram':
        // Web share API for modern browsers, fallback to copy link
        if (navigator.share) {
          navigator.share({
            title: 'Post',
            text: post.caption,
        ...
        <div className="modal-overlay" onClick={() => setSelectedPost(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-image-container">
               <img src={selectedPost.image} alt="selected" className="modal-image" />
            </div>
            {selectedPost.caption && <p className="modal-caption">{selectedPost.caption}</p>}
            
            <div className="modal-actions">
              <button className="action-btn download-btn" onClick={() => handleDownload(selectedPost.image)}>
              ...
              <div className="share-buttons">
                <button className="share-btn whatsapp" onClick={() => handleShare('whatsapp', selectedPost)}>
                ...
                <button className="share-btn facebook" onClick={() => handleShare('facebook', selectedPost)}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </button>
                <button className="share-btn instagram" onClick={() => handleShare('instagram', selectedPost)}>
